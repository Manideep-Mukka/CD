...
{
      12,     1,    13,     7,     8,    14,    15,     4,     5,     0,
       6
};

static const yytype_int8 yycheck[] =
{
       6,     3,     8,     3,     4,    12,    13,     5,     0,    -1,
       9
};
...
#line 1080 "parser.tab.c"
  ...
  case 3: /* stmt: IDENTIFIER ASSIGN expr  */
#line 31 "parser.y"
                           {
        char *result = malloc(100);
        snprintf(result, 100, "assign %s = %s", (yyvsp[-2].str), (yyvsp[0].str));
        free((yyvsp[-2].str));
        free((yyvsp[0].str));
        (yyval.str) = result;
    }
#line 1092 "parser.tab.c"
  ...
  case 4: /* expr: term SUB factor  */
#line 41 "parser.y"
                    {
        char *result = malloc(100);
        snprintf(result, 100, "(%s - %s)", (yyvsp[-2].str), (yyvsp[0].str));
        free((yyvsp[-2].str));
        free((yyvsp[0].str));
        (yyval.str) = result;
    }
